...
class FavoriteMoviesTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, numberOfRowsInSection section: Int) -> Int {
        ...
        return MovieManager.shared.favoritesArray.count
    }

    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
          let cell = tableView.dequeueReusableCell(withIdentifier: MovieTableViewCell.identifier, for: indexPath) as! MovieTableViewCell
        cell.configure(with: MovieManager.shared.favoritesArray[indexPath.row])
     ...
     override func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
          ...
          // Show movie details
        let url = "https://www.imdb.com/title/\(MovieManager.shared.favoritesArray[indexPath.row].imdbID)/"
